...
{
  public Task<Result<List<TransactionDataDto>>> GetTransactionsByDateAsync(int userId, DateTime startDate, DateTime endDate, DateType dateType, CancellationToken cancellationToken = default);
